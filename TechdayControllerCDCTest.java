...
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.atsistemas.techday:techday-apis:+:stubs:8080")
@DirtiesContext
public class TechdayControllerCDCTest  {
	...
	public void addEmployeeTest() throws Exception {
		...
		mvc.perform(
				post("/example3/techday/{id}/employees/",123)
